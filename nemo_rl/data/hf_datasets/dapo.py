...
def format_dapo_math(data: dict[str, Any]) -> dict[str, list[Any] | str]:
    # Extract user content from prompt field
    user_content = ""
    ...
    assistant_content = data["reward_model"]["ground_truth"]
...
class DAPODataset:
    def __init__(self, seed: int = 42) -> None:
        """Initialize the DAPO dataset with train/test split.
